...
const Login = () => {
  ...
  return (
      <View style={style.container}>
        ...
        <TextInput keyboardType='email-address' label="Email" mode='outlined' style={style.input} onChangeText={setEmail} value={email}/>
        <TextInput secureTextEntry passwordRules label="Senha" mode='outlined' style={style.input} onChangeText={setPassword} value={password}/>
